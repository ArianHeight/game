...
public class DemoUpgradeStore extends MouseAdapter {
	
	
	private HUD hud;
	
	private int [] baseCosts = {0, 0, 0, 0, 0};
	private int [] upgradeIncreases = {0, 0, 0, 0, 0};
	...
	private int [] ballCosts = {0, 0, 0, 0, 0, 0};
	
	public DemoUpgradeStore(HUD hud){
		this.hud = hud;
